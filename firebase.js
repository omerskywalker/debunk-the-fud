...
import { collection, getDocs, addDoc, setDoc, doc, Timestamp } from "https://www.gstatic.com/firebasejs/9.1.1/firebase-firestore.js"
...
document.getElementById('visitor-counter').innerHTML = `<span class="viewCount">${currentViewCountObj.viewCount}</span> nocoiners educated`;
